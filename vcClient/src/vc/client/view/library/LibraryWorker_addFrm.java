...
public class LibraryWorker_addFrm extends JFrame {
	...
	public LibraryWorker_addFrm(User u) {
		...
		lblNewLabel.setBounds(95, 68, 100, 41);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("\u4E66\u7C4D\u540D\u79F0:");
		lblNewLabel_1.setFont(new Font("宋体", Font.PLAIN, 18));
		lblNewLabel_1.setBounds(95, 119, 90, 35);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("\u4E66\u7C4D\u6570\u91CF:");
		lblNewLabel_2.setFont(new Font("宋体", Font.PLAIN, 18));
		lblNewLabel_2.setBounds(95, 281, 90, 35);
		contentPane.add(lblNewLabel_2);
		
		bookID = new JTextField();
		bookID.setBackground(new Color(255, 255, 240));
		bookID.setBounds(199, 68, 185, 39);
		contentPane.add(bookID);
		bookID.setColumns(10);
		
		bookname = new JTextField();
		bookname.setBackground(new Color(255, 255, 240));
		bookname.setBounds(199, 120, 185, 41);
		contentPane.add(bookname);
		bookname.setColumns(10);
		
		booknumber = new JTextField();
		booknumber.setBackground(new Color(255, 255, 240));
		booknumber.setBounds(199, 280, 185, 40);
		...
		lblNewLabel_3.setBounds(31, 10, 306, 42);
