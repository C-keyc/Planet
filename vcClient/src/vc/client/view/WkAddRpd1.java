...
public class WkAddRpd1 extends JFrame {
	...
	public WkAddRpd1() {
		setTitle("\u5FEB\u4E50\u661F\u7403\u865A\u62DF\u6821\u56ED\u5546\u5E97");
		//setIconImage(Toolkit.getDefaultToolkit().getImage(WkAddRpd1.class.getResource("/image/logo.jpg")));
